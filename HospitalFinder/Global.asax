...
<script runat="server">
    ...
    public static void RegisterRoutes(System.Web.Routing.RouteCollection routes)
    {
        ...
        routes.MapPageRoute(
            "StateWiseHospital",
            "HospitalFinder/StateWiseHospital",
            "~/ClientPanel/StateWiseHospital.aspx"
            );

        routes.MapPageRoute(
            "CityWiseHospital",
            "HospitalFinder/CityWiseHospital",
            "~/ClientPanel/CityWiseHospital.aspx"
            );

        routes.MapPageRoute(
            "StateWiseHospitalList",
            "HospitalFinder/StateWiseHospitalList/{StateID}",
            "~/ClientPanel/StateWiseHospitalList.aspx"
            );

        routes.MapPageRoute(
            "CityWiseHospitalList",
            "HospitalFinder/CityWiseHospitalList/{CityID}",
            "~/ClientPanel/CityWiseHospitalList.aspx"
            );

        routes.MapPageRoute(
            "HospitalDetails",
            "HospitalFinder/HospitalDetails/{HospitalID}",
